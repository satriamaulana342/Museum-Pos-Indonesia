  ...
  <body>
    ...
    <div class="container-fluid py-6 px-5">
      <div class="row g-5">
        ...
        <div class="col-lg-7">
          <h1 class="display-5 text-uppercase mb-4">Profil <span class="text-primary">{{$profil->heading}}</span></h1>
      ...
      <div class="row g-5">
        <div class="col-lg-6 pe-lg-5">
          <div class="d-flex justify-content-center">
            <a href="/" class="navbar-brand"><img src="{{ url('asset/footer-logo.webp') }}" class="mb-4 footer-logo mx-auto" style="" alt="logo footer" /></a>
          </div>
