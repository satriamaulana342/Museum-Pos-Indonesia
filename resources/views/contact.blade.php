  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg bg-light navbar-dark navbar-light py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav ms-auto py-0">
            ...
            <a href="/contact" class="nav-item nav-link active">Kontak</a>
    ...
    <div class="container-fluid page-header">
      ...
      <div class="d-inline-flex text-white">
        ...
        <h6 class="text-uppercase text-white m-0">Kontak</h6>
      </div>
    </div>
    <!-- Page Header Start -->
    ...
    <div class="container-fluid bg-light py-6 px-5">
      <div class="row">
        <div class="col-lg-6">
          <div class="embed-responsive embed-responsive-16by9 my-4 bg-light rounded shadow d-md-flex justify-content-md-center">
            <iframe
              class="rounded"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.9041818561172!2d107.61974389999997!3d-6.902061499999987!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e64b5afecaeb%3A0x12b93c9309d6b441!2sMuseum%20Pos%20Indonesia!5e0!3m2!1sid!2sid!4v1654587192025!5m2!1sid!2sid"
              width="800"
              height="445"
              style="border: 0"
              allowfullscreen=""
        ...
        <div class="col-lg-6 my-auto">
          <h1 class="text-end my-3 display-3 text-uppercase">Museum <span class="text-primary">Pos Indonesia</span></h1>
          <div class="text-end" style="font-size: 18px">
            <p>Jl. Cilaki No.73, Kota Bandung, Jawa Barat 40115<i class="fa fa-map-marker-alt ms-2"></i>.</p>
            <p>(022) 4203195<i class="fa fa-phone-alt ms-2"></i></p>
            <p>museumposindonesia@email.com<i class="fa fa-envelope ms-2"></i></p>
            <p>Senin - Jumat Pukul 08.00 - 15.00 (Hari Libur Nasional Tutup)<i class="fa fa-clock ms-2"></i></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Footer Start -->
    <div class="container-fluid position-relative bg-dark bg-light-radial text-white-50 py-3 px-5">
      <div class="row g-5">
        <div class="col-lg-6 pe-lg-5">
          <div class="d-flex justify-content-center">
            <a href="..//" class="navbar-brand"><img src="../img/Group 1.png" class="mb-4" style="width: 400px" alt="" /></a>
          </div>
