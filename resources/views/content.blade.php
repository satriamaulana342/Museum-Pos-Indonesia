...
<html lang="en">
  <head>
    ...
    <style>
      .page-header {
        background: linear-gradient(rgba(4, 15, 40, 0.7), rgba(4, 15, 40, 0.7)), url(../img/kerajaan.webp) center center no-repeat;
      }
    </style>
  ...
  <body>
    ...
    <div class="container my-5">
      ...
      <div class="d-flex justify-content-center my-3">
        <img src="{{asset('storage/article/'. $content->thumbnail)}}"  width="300" alt="" />
      </div>
