...
<body>
    ...
    @endif
    <form method="POST" action="/dashboard/ruangan/{{$data->id}}/edit" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <img src="{{asset('/storage/photos/1/Thumbnails/'. $data->thumbnail)}}" alt="" width="150">
