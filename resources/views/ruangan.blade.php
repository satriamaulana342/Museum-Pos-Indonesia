...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg bg-light navbar-dark navbar-light py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav ms-auto py-0">
            ...
            <a href="ruangan.html" class="nav-item nav-link active">Ruangan</a>
    ...
    <div class="container-fluid page-header">
      <h1 class="display-3 text-uppercase text-white mb-3">Ruangan Museum POS indonesia</h1>
      <div class="d-inline-flex text-white">
        <h6 class="text-uppercase m-0"><a href="index.html">Beranda</a></h6>
        <h6 class="text-white m-0 px-3">/</h6>
        <h6 class="text-uppercase text-white m-0">Ruangan</h6>
      </div>
    </div>
    <!-- Page Header Start -->
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item h-card bg-white d-flex flex-column align-items-center text-center">
            ...
            <div class="p-4 pb-4">
              ...
              <a class="btn btn-primary" href="ruangan.html"> Baca Lebih lanjut <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12">
          <div class="service-item h-card bg-white rounded d-flex flex-column align-items-center text-center">
            ...
            <div class="p-4 pb-4">
              ...
              <a class="btn btn-primary" href="page/ruangsejarah.html">Baca Lebih Lanjut<i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
        </div>
      </div>
