    ...
    <div class="container-fluid bg-light py-6 px-5">
      <div class="row g-5">
        ...
        <div class="col-lg-4 col-md-12">
          <div class="service-item h-card bg-white rounded d-flex flex-column align-items-center text-center">
            <img class="w-100 object-fit" src="img/artikel/3.webp" height="200" alt="" />
            <div class="p-4 pb-4">
              <h4 class="text-uppercase mb-3">Artikel-1</h4>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, esse./p>
                <a class="btn text-primary" href="article/dummy.html">Baca Lebih Lanjut<i class="bi bi-arrow-right"></i></a>
              </p>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-12">
          <div class="service-item h-card bg-white rounded d-flex flex-column align-items-center text-center">
            <img class="w-100 object-fit" src="img/artikel/4.webp" height="200" alt="" />
            <div class="p-4 pb-4">
              <h4 class="text-uppercase mb-3">Artikel-1</h4>
