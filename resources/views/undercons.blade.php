    ...
    <body>
       ...
       <div class="container my-5">
        <div class="text-center">
            <img src="img/undercons.png"  width="500" alt="">
            <h1 style="font-size: 90px;  color: #ff6600;">404</h1>
    ...
    <div
        ...
        <div class="row g-5">
            ...
            <p>
                <i class="fa fa-map-marker-alt me-2"></i>Jalan Cilaki No.73 Bandung 40115.
            </p>
            <p><i class="fa fa-phone-alt me-2"></i>0892383488</p>
            <p><i class="fa fa-envelope me-2"></i>Meseum pos indonesia.co.id</p>
            </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between">
            ...
            <p class="mb-0">&copy; <a class="text-primary" href="https://www.posindonesia.co.id/id/content/museum-pos-indonesia">Pos indonesia.co.id</a>. all Rights Reserved.
            </p>
            </div>
            <div class="py-4 px-5 bg-primary footer-shape position-relative text-center text-md-end">
            <p class="mb-0"> Designed by <a class="text-dark" href="https://htmlcodex.com">HTML Codex</a>
            </p>
            </div>
        </div>
        </div>
