<form id="groupReservationForm" onsubmit="return false;">
    {{ csrf_field() }}
    <div class="row g-3">
        <div class="col-12 col-sm-6">
            <label class="form-label text-sm">Nama</label>
            <input type="text" name="nama" class="form-control border-0" placeholder="Nama" required=""
                style="height: 55px" />
        </div>
        ...
        <div class="col-12 col-sm-6">
            <label class="form-label text-sm">Instansi</label>
            <input type="text" name="instansi" class="form-control border-0" placeholder="Instansi"
                style="height: 55px" required="" />
        </div>
       
        <input type="hidden" name="jenis_reservasi" value="Rombongan">

        <div class="col-12 col-sm-6">
            <label class="form-label text-sm">Jumlah Pengunjung</label>
            <input type="text" name="jumlah_pengunjung" class="form-control border-0 numeric-input" required=""
        ...
        <div class="col-12 col-sm-6">
            ...
            <div data-target-input="nearest">
                <input name="tanggal" id="groupReservationDate" type="date" class="form-control border-0" placeholder="Tanggal kunjungan" required=""
                    style="height: 55px" max="yyyy-mm-dd" />
            </div>
        </div>
        <div class="col-12 col-sm-6">
            <label class="form-label text-sm">Waktu Kunjungan</label>
            <select name="jam" id="groupReservationTime" class="form-control border-0 bg-white" placeholder="Waktu Kunjungan / Time" style="height: 55px;" required="">
